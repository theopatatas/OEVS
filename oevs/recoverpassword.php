...
<head>
  ...
  <title>Recover Password | OEVS</title>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .left-side img { width: 120px; margin: 0 auto 20px; }
    ...
    .input-group .fa-eye, .input-group .fa-eye-slash { position: absolute; right: 12px; top: 50%; transform: translateY(-50%); color: #999; cursor: pointer; }
...
<body>
  <div class="wrapper">
    <!-- Left Panel -->
    <div class="left-side">
      <img src="pic/au.png" alt="AU Logo">
    ...
    <div class="right-side">
      <img src="pic/phinma.png" alt="PHINMA Logo" class="logo">
