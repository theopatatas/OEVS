...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    /* Dropdowns (with Admin Actions as hover submenu inside) */
    .dropdown,.submenu{
    ...
    .dropdown a, .submenu a{
      display:flex; align-items:center; gap:10px; padding:10px 12px; border-radius:10px; color:var(--primary); font-weight:600;
    }
    ...
    .submenu{position:static; padding:4px 0 0 0; border:none; box-shadow:none}
    ...
    .badge{display:inline-flex; align-items:center; gap:6px; padding:6px 10px; border-radius:999px; font-weight:700; font-size:12px; background:#eef2f7; color:#344a6a; border:1px solid #e1e8f5}
        ...
        <table id="votersTable">
          ...
          <tbody id="tableBody">
            ...
            <tr class="del<?php echo $id; ?>">
              ...
              <td><span class="badge badge-success">Voted</span></td>
              <td>
                <a class="btn btn-delete" data-id="<?php echo $id; ?>" style="background:#ffe8ea;border-color:#ffd1d6;color:#b61e1e;gap:6px">
...
<script>
  // Filter dropdown toggle (no conflict with delete)
  (function(){
