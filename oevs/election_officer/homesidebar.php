...
$main_page_map = [
  // Candidate subpages
   'result.php' => 'home1.php',
  'dashboard.php' => 'home1.php',
      ...
      <ul class="nav nav-pills">
        <li class="dropdown active">
          ...
          <ul class="dropdown-menu">
            <li class="<?php echo ($current_page == 'home1.php') ? 'active' : ''; ?>">
              <a href="home1.php" style="color: #000;"><i class="icon-home icon-large"></i> Dashboard</a>
            </li>
          </ul>
        </li>
      </ul>
