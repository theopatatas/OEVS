...
<head>
  <meta charset="UTF-8" />
  <title>Verified Voters - Online Voting System</title>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    /* ===== Header (smart sticky like home.php) ===== */
    header.smart-header{
    ...
    <div class="card">
      ...
      <div class="demo_jui">
        <table id="votersTable">
          ...
          <tbody id="tableBody">
            <?php
              $voter_query = mysqli_query($conn, "SELECT * FROM voters WHERE Verified='Verified'");
            ...
            <tr class="del<?php echo $id; ?>">
              ...
              <td align="center"><span class="badge badge-success">Verified</span></td>
              <td align="center">
...
<script>
  ...
  // Client-side search + pagination (same as voter_list.php)
  (function(){
