...
<section>
	...
	<tr class="del<?php echo $id ?>">
		...
		<td align="center">
			<?php if ($voter_rows['Verified'] == 'Not Verified') { ?>
				<button class="btn btn-success verify-btn" data-id="<?php echo $id; ?>">Verify</button>
			<?php } else { ?>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.trim() === "success") {
                        $('.verify-btn[data-id="' + id + '"]').parent().html('<span class="label label-success">Verified</span>');
                    } else {
