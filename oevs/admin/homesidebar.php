        ...
        <li class="dropdown active">
          ...
          <ul class="dropdown-menu">
            <li class="<?php echo ($current_page == 'analytics.php') ? 'active' : ''; ?>">
              <a href="analytics.php" style="color: #000;"><i class="icon-home icon-large"></i> Dashboard</a>
            </li>
            <li class="<?php echo ($current_page == 'history.php') ? 'active' : ''; ?>">
              <a href="history.php" style="color: #000;"><i class="icon-table icon-large"></i> History Log</a>
            </li>
          </ul>
        </li>
      </ul>
