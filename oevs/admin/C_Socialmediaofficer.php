...
<head>
  <meta charset="UTF-8">
  <title>Social-Media Officer - Canvassing Report</title>
...
<body>
  ...
  <div class="content-wrapper">
    ...
    <div class="table-container">
      ...
      <table id="reportTable">
        ...
        <tbody>
          <?php
          $candidate_query = mysqli_query($conn, "SELECT * FROM candidate WHERE Position='Social-Media Officer'");
  ...
  <!-- Search + items-per-page with re-apply after search -->
  <script>
    (function(){
