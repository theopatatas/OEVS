...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    /* Sticky header (same across pages) */
    header{
    ...
    .dropdown{display:none;position:absolute;top:100%;left:0;background:var(--white);box-shadow:var(--shadow);border-radius:6px;min-width:220px;padding:8px 0;z-index:99}
