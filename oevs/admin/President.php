...
<?php $candidate_query=mysqli_query($conn,"select  * from candidate where Position='President'");
...
<tr class="del<?php echo $id ?>">
    <td align="center"><?php echo htmlspecialchars($candidate_rows['Position']); ?></td>
    <td><?php echo htmlspecialchars($candidate_rows['FirstName']); ?></td>
    <td><?php echo htmlspecialchars($candidate_rows['LastName']); ?></td>
    <td align="center"><?php echo htmlspecialchars($candidate_rows['Year']); ?></td>
    <td align="center">
        <img class="pic" width="40" height="30" src="<?php echo htmlspecialchars($candidate_rows['Photo']); ?>" border="0"
             onmouseover="showtrail('<?php echo htmlspecialchars($candidate_rows['Photo']); ?>','<?php echo htmlspecialchars($candidate_rows['FirstName'] . " " . $candidate_rows['LastName']); ?>',200,5)"
