...
<head>
  <meta charset="UTF-8">
  <title>Representative - Canvassing Report</title>
...
<body>
  ...
  <div class="content-wrapper">
    ...
    <div class="table-container">
      ...
      <table id="reportTable">
        ...
        <tbody>
          <?php
          $candidate_query = mysqli_query($conn, "SELECT * FROM candidate WHERE Position='Representative'");
  ...
  <!-- Search + items-per-page (applies after search too) -->
  <script>
    (function(){
      ...
      function applyPerPage(){
        ...
        Array.from(tbody.rows).forEach((r)=>{
          const matches = r.style.display !== 'none'; // already filtered by search
          if (!matches) return;
      ...
      function applySearch(){
        ...
        // after search, re-apply per-page to the visible ones
