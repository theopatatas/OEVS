...
<head>
  <meta charset="UTF-8" />
  <title>Unvoted Voters - Online Voting System</title>
  ...
  <style>
    ...
    .btn{display:inline-flex;align-items:center;gap:8px;border:1px solid #d1d5db;background:#fff;color:#111827;
      padding:10px 14px;border-radius:8px;cursor:pointer;font-weight:600;transition:var(--transition);text-decoration:none}
...
<body>
    ...
    <div class="card">
      ...
      <div class="toolbar">
        <div class="left-tools">
          ...
          <!-- Download Excel (unvoted) -->
          <form method="POST" action="excel_unvoted_voter.php" style="display:inline">
      ...
      <div class="table-wrap">
        <table id="votersTable">
          ...
          ?>
            <tr class="del<?php echo $id; ?>">
              ...
              <td><span class="badge badge-gray">Unvoted</span></td>
              <td>
        ...
        <!-- Fallback pager (shown only if DataTables unavailable) -->
  ...
  <script>
    ...
    // ===== Delete (jQuery if present, else fetch) =====
    (function(){
    ...
    // ===== Table behavior: DataTables if available; otherwise light fallback =====
    (function(){
